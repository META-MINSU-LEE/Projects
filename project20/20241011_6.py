...
# 경로 설정
mask_dir_train = r'C:\20241013\predicted_masks'  # Deeplabv3로 예측된 마스크 경로
output_dir_train = r'C:\20241013\predicted_masks_output'  # 결과 저장 경로
...
# 클래스별 평균 거리, 최소 거리, 최대 거리 계산 및 개별 값 출력
for cls in classes:
    avg_distances = []
    min_distances = []
    max_distances = []
    ...
    if avg_distances:
        ...
        print(f"\n{cls} 카테고리 전체 평균 거리: {overall_avg_distance}")
