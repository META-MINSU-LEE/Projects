...
for cls in classes:
    ...
    if avg_distances:
        ...
        overall_avg_min_distance = np.mean(min_distances)  # 최소 거리들의 평균
        overall_avg_max_distance = np.mean(max_distances)  # 최대 거리들의 평균

        print(f"{cls} 카테고리 평균 거리: {overall_avg_distance}")
        print(f"{cls} 카테고리 최소 거리의 평균: {overall_avg_min_distance}")
        print(f"{cls} 카테고리 최대 거리의 평균: {overall_avg_max_distance}")
    else:
